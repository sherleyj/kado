...
urlpatterns = [
    ...
    url(r'^user/(?P<user_id>[0-9]+)/(?P<wishlist_id>[0-9]+)/edit_item_new/$', views.editItemNew, name="edititemnew"),
    ...
    url(r'^user/(?P<user_id>[0-9]+)/(?P<wishlist_id>[0-9]+)/(?P<item_id>[0-9]+)/edit_item/$', views.editItemNew, name="edititemuser"),
